  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <canvas
          ref={canvasRef}
          className="h-[420px] w-full cursor-crosshair rounded-md border border-border"
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div ref={containerRef} className="h-[420px] w-full rounded-md border border-border" />
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        <CollapsibleControls label="Vector Components">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-md border border-red-500/30 bg-red-500/5 p-3">
              <p className="text-xs font-semibold text-red-400">Vector ⃗A</p>
            ...
            <div className="rounded-md border border-green-500/30 bg-green-500/5 p-3">
              <p className="text-xs font-semibold text-green-400">Vector ⃗B</p>
              <div className="mt-2 grid grid-cols-3 gap-2">
                {(["x", "y", "z"] as const).map((k) => (
                  <div key={k}>
                    <Label className="text-[10px] text-muted-foreground">{k}</Label>
        ...
        <div ref={containerRef} className="h-[400px] w-full rounded-md border border-border" />
        ...
        <MeaningPanel
          ...
          points={[
            ...
            "Angle formula: cos θ = (AₓBₓ + AᵧBᵧ + A₂B₂)/(|A||B|)",
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <canvas ref={canvasRef} className="h-[420px] w-full rounded-md border border-border" />
