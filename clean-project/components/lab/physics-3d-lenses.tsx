    ...
    async function init() {
      try {
        ...
        function updateRays() {
          ...
          const r2Cont = new THREE.Line(r2ContGeo, new THREE.LineBasicMaterial({ color: 0xfbbf24, linewidth: 2, transparent: true, opacity: 0.9, dashed: true }));
          rayGroup.add(r2Cont);
          ...
          const r3Cont = new THREE.Line(r3ContGeo, new THREE.LineBasicMaterial({ color: 0xa855f7, linewidth: 2, transparent: true, opacity: 0.8, dashed: true }));
          rayGroup.add(r3Cont);
        }
