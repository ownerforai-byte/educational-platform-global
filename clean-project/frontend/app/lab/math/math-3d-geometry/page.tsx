        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-semibold leading-none">3D Geometry</h1>
                <p className="text-[10px] text-muted-foreground mt-0.5">Unit: 3D Geo · Points, lines, planes in 3D.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-5">
        <div className="elev-2 rounded-2xl border border-border overflow-hidden bg-card">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-border" style={{ background: "linear-gradient(to right, #8b5cf608, transparent)" }}>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-base">3D Geometry</h2>
              <p className="text-xs text-muted-foreground truncate">Points, lines, planes in 3D.</p>
            </div>
        ...
        <div className="mt-5">
          ...
          <div className="flex flex-wrap gap-2">
            {[{ id: 'math-3d-surfaces', title: '3D Mathematical Surfaces' }, { id: 'math-3d-advanced', title: 'Mathematics 3D Advanced' }, { id: 'math-3d-fourier', title: 'Fourier Series 3D' }, { id: 'math-3d-decay', title: 'Nuclear Decay Simulator' }, { id: 'symbols-math', title: 'Symbols — Mathematics' }, { id: 'math-th-calculus', title: 'Calculus Theory' }].map((l) => (
