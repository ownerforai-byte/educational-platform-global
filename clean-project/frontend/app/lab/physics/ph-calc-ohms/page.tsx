...
export default function PhysicsInteractivePage() {
  return (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-semibold leading-none">Ohm's Law Calc</h1>
        ...
        <div className="elev-2 rounded-2xl border border-border overflow-hidden bg-card">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-border" style={{ background: "linear-gradient(to right, #3b82f608, transparent)" }}>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-base">Ohm's Law Calc</h2>
              <p className="text-xs text-muted-foreground truncate">Calculate V, I, R.</p>
            </div>
          ...
          <div className="p-5">
            <PhysicsInteractive defaultTab="ohms" />
          </div>
        </div>
        <div className="mt-5">
