...
const TOPICS = [
  ...
  },
  {
    ...
    items: [
      "लिङ्गको परिचय",
      "पुंलिङ्ग (Masculine) र स्त्रीलिङ्ग (Feminine)",
  ...
  },
  {
    ...
    items: [
      ...
      "द्वन्द्व समास",
      "तत्पुरुष समास",
      "बहुव्रीहि, अव्ययीभाव, कर्मधारय समास",
    ],
  },
  {
    title: "शब्द परिवर्तन",
...
const EXAMPLE_SENTENCES = [
  ...
  { sentence: "उनै किताब पढिरहेका छन्।", analysis: "सतत वर्तमान काल — प्रत्यय: -इरहेका छन्" },
  { sentence: "मलाई पुस्तक चाहिएको छ।", analysis: "सम्प्रदान कारक: मलाई, क्रिया: चाहिएको छ" },
];

export default function ByakaranPage() {
  return (
    <div className="mx-auto max-w-4xl space-y-6 py-6 md:py-10 px-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl md:text-2xl font-bold">नेपाली व्याकरण (Byakaran)</h1>
