...
export default function Class11Math3DPlusPage() {
  return (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-semibold leading-none">Class 11 Math 3D Plus</h1>
                <p className="text-[10px] text-muted-foreground mt-0.5">Class 11 Math · Extended 3D math.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-5">
        <div className="elev-2 rounded-2xl border border-border overflow-hidden bg-card">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-border" style={{ background: "linear-gradient(to right, #f43f5e08, transparent)" }}>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-base">Class 11 Math 3D Plus</h2>
              <p className="text-xs text-muted-foreground truncate">Extended 3D math.</p>
            </div>
        ...
        <div className="mt-5">
          ...
          <div className="flex flex-wrap gap-2">
            {[{ id: 'class11-physics', title: 'Class 11 Physics 3D Plus' }, { id: 'class11-chemistry', title: 'Class 11 Chemistry 3D Plus' }, { id: 'class11-biology', title: 'Class 11 Biology 3D Plus' }].map((l) => (
