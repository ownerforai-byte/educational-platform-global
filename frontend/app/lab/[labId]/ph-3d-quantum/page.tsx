          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground mt-0.5">Unit: Quantum · Quantum mechanics — orbitals, probability distributions, spin.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-5">
        ...
        <div className="mt-5">
          ...
          <div className="flex flex-wrap gap-2">
            {["ph-3d-dynamics", "ph-3d-advanced", "ph-3d-wave", "ph-3d-pendulum", "ph-3d-em", "ph-3d-magnetic"].map((id) => (
