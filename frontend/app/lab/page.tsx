...
import { Loader2, AlertCircle, BookOpen, Beaker, Atom, Calculator, ChevronRight, ChevronDown, FlaskConical, Dna, Microscope, Leaf, Activity, TestTube, Atom as AtomIcon, Brain, Eye, Wind, Zap, Waves, Thermometer, Gauge, Compass, Ruler, Scale, Timer, TrendingUp, Database, FileText, Star, Heart, Globe, Users, GraduationCap, Search, Cuboid, Infinity as InfinityIcon, Columns3, Move3d, Target, Crosshair, Binary, Sparkles, Bolt, Grid3x3, Sigma, BarChart3, Layers, FunctionSquare, Triangle, Hexagon, Radio, Aperture, TreeDeciduous, Heart as HeartIcon, Users as UsersIcon, Leaf as LeafIcon, Cuboid as CuboidIcon, Box, Flame, TestTube as TestTubeIcon, Wind as WindIcon, Thermometer as ThermometerIcon, CircuitBoard, ScanEye, Move3d as Move3dIcon, Target as TargetIcon2, TrendingUp as TrendingUpIcon, Crosshair as CrosshairIcon } from "lucide-react";
