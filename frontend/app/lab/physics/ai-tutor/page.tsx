          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground mt-0.5">Premium · Get instant help.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="elev-2 rounded-2xl border border-border overflow-hidden bg-card">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-border" style={{ background: "linear-gradient(to right, #f59e0b08, transparent)" }}>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-base">AI Lab Tutor</h2>
              <p className="text-xs text-muted-foreground truncate">Get instant help.</p>
            </div>
          ...
          <div className="p-5">
            <PremiumPlaceholder title="AI Lab Tutor" description="Get instant help." />
          </div>
        </div>
        <div className="mt-5">
