        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-semibold leading-none">Statistics Calculator</h1>
                <p className="text-[10px] text-muted-foreground mt-0.5">Unit: Stats · Mean, median, mode.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="elev-2 rounded-2xl border border-border overflow-hidden bg-card">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-border" style={{ background: "linear-gradient(to right, #8b5cf608, transparent)" }}>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-base">Statistics Calculator</h2>
              <p className="text-xs text-muted-foreground truncate">Mean, median, mode.</p>
            </div>
          ...
          <div className="p-5">
            <MathInteractive defaultTab="statistics" />
          </div>
        </div>
        <div className="mt-5">
