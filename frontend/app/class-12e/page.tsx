...
export default function Class12EPage() {
  const subjects = [
    { slug: "biology", name: "Biology", desc: "Biology content for Class 12E." },
    { slug: "chemistry", name: "Chemistry", desc: "Chemistry content for Class 12E." },
    { slug: "english", name: "English", desc: "English content for Class 12E." },
    { slug: "mathematics", name: "Mathematics", desc: "Mathematics content for Class 12E." },
    { slug: "nepali", name: "Nepali", desc: "Nepali content for Class 12E." },
    { slug: "physics", name: "Physics", desc: "Physics content for Class 12E." },
  ];
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 py-8 md:py-14 px-4">
      <div className="rounded-2xl border border-border/60 bg-gradient-to-br from-primary/8 via-background to-background p-8 md:p-10 shadow-lg">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight">💡 Class 12E</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {subjects.map((s) => (
          <Link key={s.slug} href={`/class-12e/${s.slug}`}>
