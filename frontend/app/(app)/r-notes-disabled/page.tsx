...
export const metadata: Metadata = {
  title: "Notes Directory & Migration Guide — NEB Study Vault",
  description:
    "R Notes have been fully integrated into official Grade 11 & Grade 12 curriculum tracks. Browse all subjects, units, and chapters.",
};
    ...
    <div className="mx-auto max-w-5xl py-10 px-4 space-y-10">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1.5 max-w-2xl">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-primary/15 text-primary text-xs font-semibold">
              ...
              <span>Notes Successfully Unified</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-foreground">
              Official Curriculum Notes Hub
            </h1>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Standalone export notes from <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-xs text-foreground font-semibold">/r-notes</code> are now natively integrated under the official CDC syllabus order for each subject. Choose a grade and subject below to start reading.
            </p>
          </div>
        ...
        <div className="flex items-center justify-between pb-2 border-b border-border/60">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Select a subject to view theory chapters and units</p>
            </div>
          </div>
          <Link
            href="/class-11-notes"
      ...
      <div className="rounded-2xl border border-border/60 bg-muted/20 p-5 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-medium text-muted-foreground">Looking for other study materials?</span>
        </div>
