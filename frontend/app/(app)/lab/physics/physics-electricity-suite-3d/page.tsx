...
export default function ElectricitySuite3DPage() {
  return (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-semibold leading-none">3D Electricity Suite</h1>
                <p className="text-[10px] text-muted-foreground mt-0.5">Unit: Electricity · Capacitor, dielectric, meter bridge.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="elev-2 rounded-2xl border border-border overflow-hidden bg-card">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-border" style={{ background: "linear-gradient(to right, #3b82f608, transparent)" }}>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-base">3D Electricity Suite</h2>
              <p className="text-xs text-muted-foreground truncate">Capacitor, dielectric, meter bridge.</p>
            </div>
