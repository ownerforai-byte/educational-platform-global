      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-5">
        ...
        <div className="mt-5">
          ...
          <div className="flex flex-wrap gap-2">
            {[{ id: 'ph-3d-dynamics', title: 'Dynamics 3D' }, { id: 'ph-3d-advanced', title: 'Physics 3D Advanced' }, { id: 'ph-3d-quantum', title: 'Quantum 3D' }, { id: 'ph-3d-wave', title: 'Wave Simulator 3D' }, { id: 'ph-3d-pendulum', title: 'Pendulum 3D' }, { id: 'ph-3d-magnetic', title: 'Magnetic Field 3D' }].map((l) => (
