...
export default function Class12MorePage() {
  const subjects = [
    { slug: "biology", name: "Biology", desc: "Biology content for Class 12 More." },
    { slug: "chemistry", name: "Chemistry", desc: "Chemistry content for Class 12 More." },
    { slug: "english", name: "English", desc: "English content for Class 12 More." },
    { slug: "mathematics", name: "Mathematics", desc: "Mathematics content for Class 12 More." },
    { slug: "nepali", name: "Nepali", desc: "Nepali content for Class 12 More." },
    { slug: "physics", name: "Physics", desc: "Physics content for Class 12 More." },
  ];
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 py-8 md:py-14 px-4">
      <div className="rounded-2xl border border-border/60 bg-gradient-to-br from-primary/8 via-background to-background p-8 md:p-10 shadow-lg">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight">📦 Class 12 More</h1>
        <p className="mt-2 text-muted-foreground">
          Additional resources and supplementary content for Class 12.
        </p>
      </div>

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {subjects.map((s) => (
          <Link key={s.slug} href={`/class-12-more/${s.slug}`}>
