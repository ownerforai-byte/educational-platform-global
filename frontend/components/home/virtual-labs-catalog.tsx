...
const LABS_DATA: Record<LabDomain, LabCardData[]> = {
  physics: [
    ...
    },
    {
      ...
      href: "/lab/ph-3d-heat-determinations",
      badge: "Experiment",
    ...
    },
    {
      ...
      href: "/lab/ph-sim-double-pendulum",
      badge: "Simulator",
  ...
  biology: [
    ...
    },
    {
      ...
      href: "/lab/bio-calc-photosynthesis",
      badge: "Simulator",
      badgeColor: "bg-violet-500/15 text-violet-500 border-violet-500/30",
    },
    {
