...
export function PhysicsBouncingBall() {
  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='rounded-md border border-primary/20 bg-primary/5 p-3'>
        ...
        <h4 className='mt-1 text-sm font-semibold'>Bouncing Ball - Coefficient of Restitution</h4>
        <p className='mt-1 text-xs text-muted-foreground'>e = v_after / v_before determines energy retention per bounce. Each bounce height: h_n = e^(2n) * h_0. Real balls lose energy to heat, sound, and deformation.</p>
