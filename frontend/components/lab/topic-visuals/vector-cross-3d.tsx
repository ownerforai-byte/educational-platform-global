...
/* ============================================================
   Cross Product 3D â€” NEB Analytic Geometry & Vectors (Maths 11)
...
export function VectorCross3DVisual() {
  ...
  if (!isWebGL) {
    return <WebGLFallback title="Cross Product 3D" description="Interactive 3D vector visualization â€” requires WebGL." />;
  }
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex flex-wrap items-center gap-2">
          <span>Cross Product 3D â€” Addition, Collinearity & Coplanarity</span>
