...
/* ============================================================
   Vector Addition 3D â€” NEB Analytic Geometry & Vectors (Maths 11)
...
export function VectorAddition3DVisual() {
  ...
  if (!isWebGL) {
    return <WebGLFallback title="Vector Addition 3D" description="Interactive 3D vector visualization â€” requires WebGL." />;
  }
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex flex-wrap items-center gap-2">
          <span>Vector Addition 3D â€” Addition, Collinearity & Coplanarity</span>
