    ...
    subjects: [
      {
        slug: "biology",
        name: "Biology",
        description: "Supplementary biology resources and practical work.",
        units: [
          {
            id: "general-topics",
            title: "General Topics",
            topics: ["Concept Maps", "Diagram Practice", "Case Studies", "Biology Projects", "Field Trips", "Recent Discoveries", "Quick Revision Notes", "Competitive Exam Prep", "Laboratory Skills"],
          },
        ],
      },
      {
        slug: "chemistry",
        name: "Chemistry",
        description: "Supplementary chemistry resources and practice problems.",
        units: [
          {
            id: "general-topics",
            title: "General Topics",
            topics: ["Chemical Calculations", "Organic Reactions", "Inorganic Trends", "Qualitative Analysis", "Chemistry Projects", "Laboratory Safety", "Molecular Models", "Quick Revision Notes", "Competitive Exam Prep"],
          },
        ],
      },
      {
        slug: "english",
        name: "English",
        description: "Supplementary English language and literature resources.",
        units: [
          {
            id: "general-topics",
            title: "General Topics",
            topics: ["Vocabulary Enhancement", "Writing Workshops", "Literature Circles", "Public Speaking", "Drama and Performance", "Research Projects", "Quick Revision Notes", "Grammar Drills", "Reading Challenges"],
          },
        ],
      },
      {
        slug: "mathematics",
        name: "Mathematics",
        description: "Supplementary mathematics resources and practice problems.",
        units: [
          {
            id: "general-topics",
            title: "General Topics",
            topics: ["Problem Solving Techniques", "Graphing and Visualization", "Mathematical Modeling", "Puzzle and Games", "Math Projects", "Competitive Mathematics", "Quick Revision Notes", "Formula Sheets", "Mental Math"],
          },
        ],
      },
      {
        slug: "nepali",
        name: "Nepali",
        description: "Supplementary Nepali language and literature resources.",
        units: [
          {
            id: "general-topics",
            title: "General Topics",
            topics: ["लेखन कौशल विकास", "साहित्यिक चर्चा", "व्याकरण अभ्यास", "पाठ योजना", "सांस्कृतिक कार्यक्रम", "अनुसन्धान परियोजना", "द्रुत पुनरावृत्ति", "विचार प्रश्न", "मूल्याङ्कन परीक्षण"],
          },
        ],
      },
      {
        slug: "physics",
        name: "Physics",
        description: "Supplementary physics resources and practice problems.",
        units: [
          {
            id: "general-topics",
            title: "General Topics",
            topics: ["Numerical Problem Solving", "Conceptual Questions", "Previous Year Questions", "Mock Tests", "Physics Projects", "Laboratory Manual", "Formula Reference", "Quick Revision Notes", "Competitive Exam Prep"],
          },
        ],
      },
    ],
