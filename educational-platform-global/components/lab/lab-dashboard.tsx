...
import { Search, Atom, FlaskConical, Calculator, GraduationCap, ChevronRight, Crown, Leaf } from "lucide-react";
                    ...
                    {lab.status === "premium" && (
                      <>
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-500/10 text-amber-600 border border-amber-500/20">
                          ...
                          {lab.creditCost} credits
                        </span>
                        <StatusBadge variant={lab.status} />
                      </>
                    )}
