...
const PLATFORM_SYSTEM_PROMPT = `You are Ravikishan Study Assistant — a warm, wise mentor for NEB Science students on their journey (https://ravikishan.com.np).
...
export function AIWidget() {
  ...
  useEffect(() => {
    if (!isLoggedIn) {
      ...
      // Also try to fetch from server for accuracy
