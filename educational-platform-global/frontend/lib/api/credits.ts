...
export async function getAdminTransactions(page = 1, limit = 50): Promise<{ transactions: CreditTransaction[]; total: number }> {
  return apiFetch<{ transactions: CreditTransaction[]; total: number }>(
