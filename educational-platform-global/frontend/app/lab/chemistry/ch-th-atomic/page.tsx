        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm font-semibold leading-none">Atomic Structure Theory</h1>
                <p className="text-[10px] text-muted-foreground mt-0.5">Unit: Atomic · Bohr model, quantum numbers.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="elev-2 rounded-2xl border border-border overflow-hidden bg-card">
          <div className="flex items-center gap-3 px-5 py-3 border-b border-border" style={{ background: "linear-gradient(to right, #10b98108, transparent)" }}>
            ...
            <div className="flex-1 min-w-0">
              <h2 className="font-semibold text-base">Atomic Structure Theory</h2>
              <p className="text-xs text-muted-foreground truncate">Bohr model, quantum numbers.</p>
            </div>
          ...
          <div className="p-5">
            <TheoryPanel subject="chemistry" topic="atomic" />
          </div>
        </div>
        <div className="mt-5">
          <h3 className="font-semibold text-sm text-muted-foreground mb-3">Related Labs</h3>
          <div className="flex flex-wrap gap-2">
            {[{ id: 'ch-3d-periodic', title: 'Periodic Table 3D' }, { id: 'ch-3d-advanced', title: 'Chemistry 3D Advanced' }, { id: 'ch-3d-micro', title: 'Microscopy 3D' }, { id: 'ch-th-bonding', title: 'Chemical Bonding Theory' }, { id: 'ch-th-eq', title: 'Equilibrium Theory' }, { id: 'ch-th-thermo', title: 'Thermochemistry Theory' }].map((l) => (
