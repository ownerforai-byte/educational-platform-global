      ...
      case "bohr-hydrogen-atom":
        return (
          <svg viewBox="0 0 700 500" className="w-full h-auto select-none">
            ...
            <text x="210" y="405" textAnchor="middle" fill="#f59e0b" fontSize="12">E_n = -13.6/n² eV</text>
          ...
          <svg viewBox="0 0 700 500" className="w-full h-auto select-none">
            ...
            {[1,2,3,4,5,'∞'].map((n,i) => (
              <g key={n}>
                ...
                <text x="320" y={295+i*25} fill="#64748b" fontSize="9">{n==='∞'?'0':((-13.6/n/n).toFixed(1))+'eV'}</text>
              </g>
            ))}
            {/* Series info */}
      ...
      case "molecular-orbital-theory":
        return (
          <svg viewBox="0 0 700 500" className="w-full h-auto select-none">
            ...
            <line x1="500" y1="160" x2="600" y1="160" stroke="#475569" strokeWidth="2"/>
      ...
      case "benzene-aromatic":
        return (
          <svg viewBox="0 0 700 500" className="w-full h-auto select-none">
            ...
            {/* Circle for delocalized electrons */}
      ...
      case "kinetic-theory-gases":
        return (
          <svg viewBox="0 0 700 500" className="w-full h-auto select-none">
            ...
            <text x="390" y="155" fill="#e2e8f0" fontSize="12">KE_avg = ³⁄₂ kT</text>
            <text x="390" y="180" fill="#94a3b8" fontSize="10">k = Boltzmann constant</text>
            <text x="390" y="210" fill="#e2e8f0" fontSize="12">v_rms = √(3RT/M)</text>
            <text x="390" y="235" fill="#94a3b8" fontSize="10">Root mean square speed</text>
            <text x="390" y="270" fill="#e2e8f0" fontSize="12">PV = ⅓ Nm(v_rms)²</text>
            {/* Real vs Ideal */}
      ...
      case "basic-concepts-chemistry":
        return (
          <svg viewBox="0 0 700 500" className="w-full h-auto select-none">
            ...
            <text x="350" y="410" textAnchor="middle" fill="#e2e8f0" fontSize="12">1 amu = ¹⁄₁₂ mass of ¹²C atom = 1.6605 × 10⁻²⁴ g</text>
          </svg>
        );
