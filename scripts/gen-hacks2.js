const fs = require("fs");
const hacks = require("./gen-hacks.js");
Object.assign(hacks, {
  confusion: [
...
fs.writeFileSync("content/ravikishan/class-11/english/writing-and-composition/concepts/01-grammar-hacks-and-shortcuts.json", JSON.stringify(hacks, null, 2) + "\n");
