#!/usr/bin/env python3
"""Insert biology SVG cases into derivation-visual.tsx before default: case."""
import re

FILE_PATH = r"C:\Users\ASUS\Desktop\rn\frontend\components\derivations\derivation-visual.tsx"

# Read the file
with open(FILE_PATH, 'r', encoding='utf-8') as f:
    content = f.read()

# Find the position of '      default:' (the last occurrence in the switch)
# We want to insert BEFORE the default case
default_match = None
...
new_content = content[:insert_pos] + biology_cases + content[insert_pos:]

# Write back
with open(FILE_PATH, 'w', encoding='utf-8') as f:
    f.write(new_content)

print(f"Successfully inserted {biology_cases.count('case ')} biology SVG cases")
